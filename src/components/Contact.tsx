...
export default function Contact() {
  ...
  return (
    <section id="kapcsolat" className="py-24 sm:py-32 relative overflow-hidden">
      <div className="absolute inset-0 -z-10 bg-gradient-to-br from-primary-light/30 via-white to-primary-light/20" />
          ...
          <FadeIn direction="left">
            <div className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground-secondary text-sm">1065 Budapest, Nagymező utca 42.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@harmonymassage.hu" className="text-primary text-sm hover:underline">
              ...
              <div className="rounded-2xl overflow-hidden border border-border shadow-sm">
                <iframe
                  src="https://www.google.com/maps?q=47.5048,19.0600&z=17&hl=hu&output=embed"
                  width="100%"
                  height="280"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="Harmony Masszázs Stúdió — térkép"
                />
              </div>
            </div>
          </FadeIn>
              ...
              >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className={inputClass}
                    placeholder="Milyen masszázsra lenne szüksége?"
                  />
                </div>
